...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'streaming')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','God_Luffy_ATI') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','Elitecraft_Studios') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','EliteCraft_Studios') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','LayDeveloperr')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "movie_request_zone5") #[ without @ ]
...
CAPTION_BUTTON_URL = "https://t.me/elitecraft_movies"
